...
public class SignUpApi {
    ...
    public String fetchRegisterNonceValueUsingGroovye(){
    ...
    private Response getAccount(){
        ...
        if(response.getStatusCode() != 200){
            throw new RuntimeException("FFailed to fetch the account, HTTP Statuis Code: " + response.getStatusCode());
        }
        return response;
    }
    ...
    public Response register(User user){
        ...
        if(response.getStatusCode() != 302){
            throw new RuntimeException("FFailed to REGISTER the account, HTTP Statuis Code: " + response.getStatusCode());
        }
